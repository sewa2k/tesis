...
Se requiere un analisis que correlacione la cuantificación de ambos parametros para establecer cual es el mejor indicador molecular del efecto inmunomodulador de $\beta$-glucanos.
